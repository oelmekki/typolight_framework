...
/**
 * Class WidgetEFileTree
 *
 * Provide methods to handle input field "file tree".
 * Just like FileTree but with the 'path' eval option in DCA
 * working as expected for tl_groups.
 * @package    Controller
 */
class WidgetEFileTree extends Widget
{
	...
	public function generate()
	{
		...
		{
                  if ( $path != $GLOBALS['TL_CONFIG']['uploadPath'] )
                  {
